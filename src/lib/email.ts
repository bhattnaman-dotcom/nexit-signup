...
<body>
  <div class="wrapper">
    ...
    <div class="hero">
      <h2>Your Agreement — Signed &amp; Payment Set Up</h2>
    </div>
    <div class="body">
      <p class="greeting">Hi ${agreement.customer_name},</p>
      <p>Thank you for signing your service agreement with NexIT Solutions. Your payment has been successfully set up. A copy of your signed agreement is attached to this email for your records.</p>
      <div class="summary">
        <table>
          ...
          <tr><td>Billing:</td><td>${agreement.billing_type === 'recurring' ? 'Recurring monthly' : 'Once-off payment'}</td></tr>
          <tr><td>Signed:</td><td>${formatDate(agreement.signed_at)}</td></tr>
          <tr><td>Status:</td><td><span class="badge">✓ Active</span></td></tr>
        </table>
      </div>
      <p class="note">If you have any questions about your agreement or services, please don't hesitate to reach out to our team.</p>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      <div class="alert">
        <h2>✅ ${agreement.customer_name} has signed and paid</h2>
        <p>${agreement.business_name} is now active</p>
      </div>
      <div class="details">
        <table>
          <tr><td>Business:</td><td>${agreement.business_name}</td></tr>
          ...
          <tr><td>Billing:</td><td>${agreement.billing_type === 'recurring' ? 'Recurring monthly' : 'Once-off'}</td></tr>
          <tr><td>Signed:</td><td>${formatDate(agreement.signed_at)}</td></tr>
  ...
  await transporter.sendMail({
    ...
    subject: `✅ ${agreement.customer_name} has signed and paid — ${agreement.business_name}`,
    html,
  });
}
